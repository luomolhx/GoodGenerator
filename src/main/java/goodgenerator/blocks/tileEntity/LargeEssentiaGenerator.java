    ...
    public boolean onRightclick(IGregTechTileEntity aBaseMetaTileEntity, EntityPlayer aPlayer) {
        if (this.getBaseMetaTileEntity()
            ...
            if (tCurrentItem != null && tCurrentItem.getItem()
                .equals(ItemRefer.Essentia_Upgrade_Empty.get(1)
                    .getItem())) {
    ...
    public IStructureDefinition<LargeEssentiaGenerator> getStructure_EM() {
        if (multiDefinition == null) {
            multiDefinition = StructureDefinition.<LargeEssentiaGenerator>builder()
                ...
                .addElement('X',
                    ofChain(buildHatchAdder(LargeEssentiaGenerator.class).atLeast(HatchElement.DynamoMulti.or(
                                    GT_HatchElement.Dynamo),
